...
onEvent('item.registry', event =>
{
    ...
    event.create('ceramic/unfired_sheet_mold').displayName('Unfired Sheet Mold').parentModel('kubejs:item/ceramic/unfired_sheet_mold').texture('kubejs:item/ceramic/unfired_sheet_mold').maxStackSize(16)
    event.create('ceramic/sheet_mold', 'tfc:mold').fluidTagAccept('kubejs:liquid_glass').displayName('Sheet Mold').parentModel('kubejs:item/ceramic/sheet_mold').texture('kubejs:item/ceramic/sheet_mold').maxStackSize(16)
    event.create('ceramic/unfired_block_mold').displayName('Unfired Block Mold').parentModel('kubejs:item/ceramic/unfired_block_mold').texture('kubejs:item/ceramic/unfired_block_mold').maxStackSize(16)
    event.create('ceramic/block_mold', 'tfc:mold').fluidTagAccept('kubejs:liquid_glass').capacity(1000).displayName('Block Mold').parentModel('kubejs:item/ceramic/block_mold').texture('kubejs:item/ceramic/block_mold').maxStackSize(16)
    event.create('ceramic/unfired_lens_mold').displayName('Unfired Lens Mold').parentModel('kubejs:item/ceramic/unfired_lens_mold').texture('kubejs:item/ceramic/unfired_lens_mold').maxStackSize(16)
    event.create('ceramic/lens_mold', 'tfc:mold').fluidTagAccept('kubejs:liquid_glass').displayName('Lens Mold').parentModel('kubejs:item/ceramic/lens_mold').texture('kubejs:item/ceramic/lens_mold').maxStackSize(16)
    event.create('lens_clear').displayName('Clear Lens').parentModel('kubejs:item/lens_clear').texture('kubejs:item/lens_clear').maxStackSize(16)
    event.create('glass_mix').displayName('Glass Mix').parentModel('kubejs:item/glass_mix').texture('kubejs:item/glass_mix').maxStackSize(32)
    event.create('unfired_glass_blower').displayName('Unfired Glass Blower').parentModel('kubejs:item/ceramic/unfired_glass_blower').texture('kubejs:item/ceramic/unfired_glass_blower').maxStackSize(16)
    event.create('ceramic/glass_blower', 'tfc:mold').fluidTagAccept('kubejs:liquid_glass').displayName('Glass Blower').parentModel('kubejs:item/ceramic/glass_blower').texture('kubejs:item/ceramic/glass_blower').maxStackSize(16)
    /*
