...
onEvent('item.registry', event =>
{   event.create('metal/axe_head/netherite').maxStackSize(1).displayName('Netherite Axe Head').parentModel('item/metal/axe_head/netherite').texture('item/metal/axe_head/netherite')
})
onEvent('item.registry', event =>
{   event.create('kubejs:metal/ingot/netherite').maxStackSize(1).displayName('Netherite Ingot').parentModel('item/metal/ingot/netherite').texture('item/metal/ingot/netherite')
})
onEvent('item.registry', event =>
{   event.create('metal/double_ingot/netherite').maxStackSize(1).displayName('Netherite Double Ingot').parentModel('item/metal/double_ingot/netherite').texture('item/metal/double_ingot/netherite')
})
onEvent('item.registry', event =>
{   event.create('metal/sheet/netherite').maxStackSize(1).displayName('Netherite Sheet').parentModel('item/metal/sheet/netherite').texture('item/metal/sheet/netherite')
})
onEvent('item.registry', event =>
{   event.create('metal/double_sheet/netherite').maxStackSize(1).displayName('Netherite Double Sheet').parentModel('item/metal/double_sheet/netherite').texture('item/metal/double_sheet/netherite')
})
onEvent('item.registry', event =>
{   event.create('metal/rod/netherite').maxStackSize(1).displayName('Netherite Rod').parentModel('item/metal/rod/netherite').texture('item/metal/rod/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/chisel_head/netherite').maxStackSize(1).displayName('Netherite Chisel Head').parentModel('item/metal/chisel_head/netherite').texture('item/metal/chisel_head/netherite')
})
onEvent('item.registry', event =>
{   event.create('metal/fish_hook/netherite').maxStackSize(1).displayName('Netherite Fish Hook').parentModel('item/metal/fish_hook/netherite').texture('item/metal/fish_hook/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/hoe_head/netherite').maxStackSize(1).displayName('Netherite Hoe Head').parentModel('item/metal/hoe_head/netherite').texture('item/metal/hoe_head/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/javelin_head/netherite').maxStackSize(1).displayName('Netherite Javelin Head').parentModel('item/metal/javelin_head/netherite').texture('item/metal/javelin_head/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/knife_blade/netherite').maxStackSize(1).displayName('Netherite Knife Blade').parentModel('item/metal/knife_blade/netherite').texture('item/metal/knife_blade/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/mace_head/netherite').maxStackSize(1).displayName('Netherite Mace Head').parentModel('item/metal/mace_head/netherite').texture('item/metal/mace_head/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/pickaxe_head/netherite').maxStackSize(1).displayName('Netherite Pickaxe Head').parentModel('item/metal/pickaxe_head/netherite').texture('item/metal/pickaxe_head/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/propick_head/netherite').maxStackSize(1).displayName('Netherite ProPick Head').parentModel('item/metal/propick_head/netherite').texture('item/metal/propick_head/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/saw_blade/netherite').maxStackSize(1).displayName('Netherite Saw Blade').parentModel('item/metal/saw_blade/netherite').texture('item/metal/saw_blade/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/scythe_blade/netherite').maxStackSize(1).displayName('Netherite Scythe Blade').parentModel('item/metal/scythe_blade/netherite').texture('item/metal/scythe_blade/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/shovel_head/netherite').maxStackSize(1).displayName('Netherite Shovel Head').parentModel('item/metal/shovel_head/netherite').texture('item/metal/shovel_head/netherite')
})
onEvent('item.registry', event =>
...
onEvent('item.registry', event =>
{   event.create('metal/sword_blade/netherite').maxStackSize(1).displayName('Netherite Sword Blade').parentModel('item/metal/sword_blade/netherite').texture('item/metal/sword_blade/netherite')
})
onEvent('item.registry', event =>
...
onEvent('fluid.registry', event => 
    {
        ...
        .color(0x31292a)
        .maxStackSize(1).displayName('Molten Netherite')
        .noBlock()
    })