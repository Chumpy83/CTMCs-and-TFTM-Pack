...
declare namespace Registry {
    ...
    class Block extends Internal.RegistryObjectBuilderTypes$RegistryEventJS<any> {
        ...
        create(id: string, type: "tfc:aqueduct"): Internal.AqueductBlockBuilder;
        create(id: string, type: "tfc:loose_rock"): Internal.LooseRockBlockBuilder;
        create(id: string, type: "tfc:groundcover"): Internal.GroundCoverBlockBuilder;
        create(id: string, type: "tfc:rock_spike"): Internal.RockSpikeBlockBuilder;
        create(id: string, type: "tfc:thin_spike"): Internal.ThinSpikeBlockBuilder;
        create(id: string, type: "tfc:moss_spreading_block"): Internal.MossSpreadingBlockBuilder;
        create(id: string, type: "tfc:moss_spreading_slab"): Internal.MossSpreadingSlabBuilder;
        create(id: string, type: "tfc:moss_spreading_stair"): Internal.MossSpreadingStairBuilder;
        create(id: string, type: "tfc:moss_spreading_wall"): Internal.MossSpreadingWallBlockBuilder;
        create(id: string, type: "tfc:moss_growing_block"): Internal.MossGrowingBlockBuilder;
        create(id: string, type: "tfc:moss_growing_slab"): Internal.MossGrowingSlabBlockBuilder;
        create(id: string, type: "tfc:moss_growing_stair"): Internal.MossGrowingStairBlockBuilder;
        create(id: string, type: "tfc:moss_growing_wall"): Internal.MossGrowingWallBlockBuilder;
        create(id: string, type: "tfc:raw_rock"): Internal.RawRockBlockBuilder;
    ...
    class Item extends Internal.RegistryObjectBuilderTypes$RegistryEventJS<any> {
        ...
        create(id: string, type: "prospector_hammer"): Internal.ProsHammerItemBuilder;
        create(id: string, type: "prospector_drill"): Internal.ProsDrillItemBuilder;
        create(id: string, type: "custom_prospector"): Internal.CustomProsItemBuilder;
        create(id: string, type: "mineral_prospector"): Internal.MineralProspectorItemBuilder;
        create(id: string, type: "tfc:mold"): Internal.MoldItemBuilder;
        create(id: string, type: "tfc:chisel"): Internal.ChiselItemBuilder;
        create(id: string, type: "tfc:mace"): Internal.MaceItemBuilder;
        create(id: string, type: "tfc:propick"): Internal.PropickItemBuilder;
        create(id: string, type: "tfc:scythe"): Internal.ScytheItemBuilder;
        create(id: string, type: "tfc:hoe"): Internal.TFCHoeItemBuilder;
        create(id: string, type: "tfc:javelin"): Internal.JavelinItemBuilder;
        create(id: string, type: "tfc:fluid_container"): Internal.FluidContainerItemBuilder;
        create(id: string, type: "tfc:tool"): Internal.ToolItemBuilder;
